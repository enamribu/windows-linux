...
`printf "#%0.s" {1..78}`
 ...
 -----------------------------   | repo): https://github.com/minlearn/inst
  -t) target *  -m) debmirror    | 自建轻量联合主机社区): https://mujj.de
